...
<!-- LC-CURRICULUM-START -->
> **Curriculum ID:** `LC-021` | **Phase 1:** Linux  
> **Est. study:** 4-5h | **Level:** Intermediate  
> **Prerequisites:** LC-015  
> **Book map:** Ward Â How Linux Works Ch.4; Shotts Â The Linux Command Line Ch.10; Stallings Â Network Security Essentials Ch.4
<!-- LC-CURRICULUM-END -->
